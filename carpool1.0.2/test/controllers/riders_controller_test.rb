...
class RidersControllerTest < ActionController::TestCase
  ...
  test "should create rider" do
    assert_difference('Rider.count') do
      post :create, rider: { deslat: @rider.deslat, deslong: @rider.deslong, email: @rider.email, sourcelat: @rider.sourcelat, sourcelong: @rider.sourcelong, time: @rider.time }
    end
  ...
  test "should update rider" do
    patch :update, id: @rider, rider: { deslat: @rider.deslat, deslong: @rider.deslong, email: @rider.email, sourcelat: @rider.sourcelat, sourcelong: @rider.sourcelong, time: @rider.time }
    assert_redirected_to rider_path(assigns(:rider))
  end
